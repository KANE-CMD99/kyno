...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "admin.creators_profile_hint": "Profile: kynocreative.com/{username}",
    ...
    "blog.field_category": "Category",
    "blog.field_excerpt": "Excerpt (shown on cards)",
    "blog.excerpt_auto": "Auto-generated from the post body — edit freely",
  ...
  zh: {
    ...
    "blog.field_category": "分类",
    "blog.field_excerpt": "摘要（显示在卡片上）",
    "blog.excerpt_auto": "从正文自动生成 · 可直接修改",

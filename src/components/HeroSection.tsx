...
export default function HeroSection() {
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6 pb-24 pt-32">
      <div className="absolute inset-0 bg-gradient-to-br from-[#07071a] via-[#0a1a2e] to-[#0a1020]" />

      <div className="animate-blob-blue absolute -top-24 -right-16 h-[400px] w-[400px] rounded-full bg-gradient-to-br from-blue-500/30 to-transparent blur-3xl" />
      ...
      <div className="absolute left-[8%] top-[15%] h-20 w-20 rotate-[15deg] rounded-2xl border border-blue-400/10" />

      <div className="absolute right-[18%] top-[25%] h-6 w-6 rotate-45 rounded-md bg-blue-400/10" />
      ...
      <div className="relative z-10 text-center">
        <h1 className="text-5xl font-black leading-[1.08] tracking-tight text-white md:text-7xl">
          <span
            ...
            style={{
              background: "linear-gradient(to bottom right, #60a5fa, #67e8f9)",
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          <a
            href="#products"
            className="rounded-lg bg-gradient-to-br from-blue-500 to-cyan-500 px-8 py-3 text-base font-medium text-white transition-opacity hover:opacity-90"
          >
            Explore Products
          </a>
          <a

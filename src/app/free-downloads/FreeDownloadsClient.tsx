...
/**
 * The listing itself is rendered on the server (see page.tsx) so the product
 * links exist in the HTML for crawlers and for visitors without JS. Only the
 * email-claim interaction lives here.
 */
export default function FreeDownloadsClient({ products }: { products: FreeProduct[] }) {
